                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      if (context.categoryProvider.addCategoryFormKey.currentState!.validate()) { //triggers the validation of the form
                        context.categoryProvider.addCategoryFormKey.currentState!.save(); //saves the form data after validation process
