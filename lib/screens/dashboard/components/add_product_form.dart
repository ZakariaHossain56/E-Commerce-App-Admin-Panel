                      ...
                      return CustomDropdown(
                        ...
                        onChanged: (category) {
                          if (category != null) {
                            ...
                            context.dashBoardProvider.filterSubcategory(category);
                          }
                        },
                        validator: (value) {
                          if (value == null) {
                      ...
                      return CustomDropdown(
                        ...
                        onChanged: (brand) {
                          if (brand != null) {
                            ...
                            context.dashBoardProvider.filterBrand(brand);
                          }
                        },
                        validator: (value) {
                          if (value == null) {
                    ...
                    child: Consumer<DashBoardProvider>(
                      builder: (context, dashProvider, child) {
                        return CustomDropdown(
                          ...
                          onChanged: (variantType) {
                            if (variantType != null) {
                              //TODO: should complete call filterVariant
                              context.dashBoardProvider.filterVariant(variantType);
